...
module.exports = {
	...
	rules:                         {
		...
		'declaration-property-unit-whitelist':                [{ 'font-size': ['rem'] }, { severity: 'warning' }],
		...
		'order/properties-order':                               [['composes', ...recessOrder.rules['order/properties-order']], { unspecified: 'bottomAlphabetical' }],
